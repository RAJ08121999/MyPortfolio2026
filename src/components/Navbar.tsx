        ...
        <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8 ">
            ...
            >
                <span className={`text-xl font-bold ${colors.textPrimary}`}>
                    Portfolio&nbsp;
                    <span className="text-orange-500">Md Raj</span>
                </span>
            </motion.a>
            ...
            <div className="hidden lg:flex items-center space-x-6">
                {
                    navItems.map((item)=>(
                        ...
                        >
                            <motion.span
                            className={`font-bold transition-colors duration-300 ${activeSection === item.name.toLowerCase() ? colors.textActive : `${colors.textSecondary} hover:text-orange-500`}`}
                            whileHover={{scale:1.05}}
                            whileTap={{scale:0.95}}
                            >
                                {item.name}
